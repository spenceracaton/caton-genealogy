...
| G013 | A | fact | active | pass16 | Aaron Caten, pension-index card ap | The original FamilySearch pension-index card reads `Caten, Aaron`, `Co. C, 3rd Mo. Cav.`, Invalid application … |
