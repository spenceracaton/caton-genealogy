# evidence/ — manifest, generated 2026-09-18 (229 files)
...
| `1850_CooperCo_MO_census_transcription_Thoma2013_Caton_entries.md` | 6 KB | — | Every Caton row from the Thoma 1850 Cooper transcription: Thomas 77 'Taylor' b. VA in John P. Maddex's Boonville household (p.148 dw.66); James 19 carpenter b. VA (dw.335); William 38 with John W. 18 b. VA (dw.357); John 53 b. Delaware (dw.902); Thomas 40 b. KY (dw.1038). |
| `1850_CooperCo_MO_census_transcription_Thoma2013_mogenweb_archive.pdf` | 6 MB | — | Jim Thoma (2013) MOGenWeb transcription of the 1850 Cooper Co. census, Wayback copy (ChatGPT register A12). Derivative, grade B. |
...
| `1850_Cooper_DeedQ_p260_ElizabethCaton.jpg` | 2 MB | — | Cooper Deed Book Q p.260 (image 443/653): Deckard to Thomas Cayton for the benefit of Elizabeth his wife, NE1/4 NE1/4 s.35 t.46 r.19, ack. 10 Oct 1850. |
| `1850_Cooper_DeedQ_p260_ElizabethCaton_crop.jpg` | 1 MB | — | Crop of the Deckard-Cayton deed. |
| `1850_Cooper_IsaacMartin_inventory_p388-389_ThomasCaton.jpg` | 2 MB | — | Cooper probate 1847-54, DGS 007636420 image 237: Isaac Martin inventory listing a 7 Mar 1846 note of Thos Caton Snr and Thos Caton Junr. |
| `1850_Cooper_IsaacMartin_inventory_p388_ThomasCaton_crop.jpg` | 312 KB | — | Crop of the Caton Snr/Junr line. |
...
| `2026-09-16_chatgpt-line_fauquier_overseers_and_related_indexes.md` | 15 KB | — | ChatGPT line, 16 Sep (recovered 18 Sep; internal G ids never allocated): Reel 116 finding aid read directly - apprentice bindings in scope (corroborates C195); APA 739 Fauquier folder 1829-51; no online copy of the volume. |
...
| `2026-09-17_Fauquier_overseers_and_marriage_public-access-check.md` | 3 KB | — | Codex (recovered 18 Sep): ARVAS/LVA confirm Reel 116 Overseers minutes 1804-1845 incl. apprentice bindings, 0 online; Fauquier Public Library marriage-returns index places Caton Thomas/William p.27, Ann p.36. |
