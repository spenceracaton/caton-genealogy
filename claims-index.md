...
| ~~G020~~ | A | fact | superseded | pass17 | Aaron Caten / Aaron Caton | The retained original NARA T288 card reads `Caten, Aaron`; service `E. 2 Mo. Cav.`; Invalid application `23378… |
...
| ~~G025~~ | A | fact | superseded | pass17 | Mary Sawtell; Gip Sawtell | An 18 March 1898 Boonville item identifies Gip Sawtell as the guest of his mother, Mrs. Mary Sawtell, document… |
...
| G027 | A | fact | active | pass18 | Aaron Caton | DIRECT ORIGINAL PERSONAL PAPER. Aaron Caton's signed veteran enlistment at Brownsville, Arkansas, on 5 January… |
| G028 | A | fact | active | pass18 | Aaron Caton | Authenticated sequential review establishes that Aaron's complete M405 CMSR jacket contains 37 Aaron images; t… |
| G029 | A | fact | active | pass18 | Aaron Caten / Aaron Caton | CORRECTION TO G020. Authenticated rereading of the original T288 card gives filing date 10 April 1876, not 12 … |
| G030 | A | fact | active | pass18 | Aaron Caten / Aaron Caton | The T289 Organization Index independently identifies Caten, Aaron, Company E, 2nd Missouri Cavalry, invalid ap… |
| G031 | B | negative | active | pass18 | Thomas Caton, age 77, Boonville ho | BOUNDED NEGATIVE SEARCH. Line-by-line review of the complete C and K sections of Cooper County's Inventory of … |
| G032 | B | hypothesis | active | pass18 | Joseph Caton; Julia A. (Caton) Saw | INFERENCE. Julia A. (Caton) Sawtell is now the strongly leading identity for Joseph Caton's unnamed March 1898… |
